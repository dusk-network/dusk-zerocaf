...
pub(crate) static EDWARDS_A: FieldElement = FieldElement([
    671914833335276,
    3916664325105025,
    1367801,
    0,
...
/// where `l = Prime of the field = 2^252 + 27742317777372353535851937790883648493`
pub(crate) static EDWARDS_D: FieldElement = FieldElement([
    4236121989480640,
    3329222317550656,
    6444852309635,
    319331980502762,
...
pub(crate) static EDWARDS_2_D_PRIME: FieldElement = FieldElement([
    3296729518255507,
    2741780309996288,
    12889703251469,
    638663961005524,
