...
impl<'a> ModSqrt for &'a FieldElement {
    ...
    fn mod_sqrt(self) -> Option<FieldElement> {
...
impl FieldElement {
    ...
    /// 
    /// Returns: 
    /// `-1` -> Non-quadratic residue (mod l). Represented as 1.
    /// 
    /// `1`  -> Quadratic residue (mod l). Represented as 0.
    /// 
    ...
    pub fn legendre_symbol(&self) -> Choice {
        ...
        res.ct_eq(&FieldElement::minus_one())
    }
