...
/// `L` is the order of base point, i.e. 2^249 - 15145038707218910765482344729778085401
...
/// `L` is the order of the Doppio Curve, i.e. 2^252 + 27742317777372353535851937790883648493`
