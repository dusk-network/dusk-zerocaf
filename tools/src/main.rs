...
fn main() {
    ...
    */
    ...
    let a = to_scalar_base_52("452312848583266388373324160190187140059081152887999797648174285421238281266");
    println!("{:?}", a);
    
    let a = to_scalar_base_52("452312848583266388373324160190187140051835877600158453279131187530910662656");
    println!("{:?}", a);
}
